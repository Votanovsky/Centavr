...
<head>
    ...
    <meta name="description" content="Центр юридических консультаций ООО ЦЕНТАВР. Юридическая поддержа от лучших юристов России">
    <link type="image/x-icon" rel="shortcut icon" href="media/icons/favicon.ico">
    <meta name="keywords" content="консультации, юристы, юридическая фирма, гражданские права"> 
    <title>Центавр || Centavr || Юридические консульации || Онлайн || Помощь юриста</title>
...
<header class="section-outer section-header">
    <div class="section-inner section-inner--wide vertical-indent vertical-indent--s">
        <div class="main-navigation" id="main-navigation">
            <a href="index.php" class="logo__link" aria-label="logo">Ц</a> <!-- атр. aria-label="" нужен для SEO, добавляется к тегу а -->
            <button class="btn_menu btn_menu--no-bg btn-burger">
                <span class="btn-burger__line btn-burger__line--one"></span>
                <span class="btn-burger__line btn-burger__line--two"></span>
                <span class="btn-burger__line btn-burger__line--three"></span>
            </button>
                ...
                <nav class="nav">
                    <ul class="nav-wrapper">
                        <li class="nav-wrapper__item">
                            <a href="#section-promo" class="nav-wrapper__item-link ">Главная</a>
                        </li>
                        <li class="nav-wrapper__item">
                            <a href="#companys" class="nav-wrapper__item-link"">Компании</a>
                        </li>
                        <li class="nav-wrapper__item">
                            <a href="#about" class="nav-wrapper__item-link">О нас</a>
                        </li>
                        <li class="nav-wrapper__item">
                            <a href="#catalog" class="nav-wrapper__item-link">Услуги</a>
                        </li>
                        <li class="nav-wrapper__item">
                            <a href="#jurists" class="nav-wrapper__item-link">Юристы</a>
                        </li>
                        <li class="nav-wrapper__item">
                            <a href="#footer" class="nav-wrapper__item-link">Контакты</a>
                        </li>
                    </ul>
                </nav>
                <div class="socials">
                    <ul class="socials-wrapper">
                        <li class="socials-wrapper__item">
                            <a href="#" class="socials-wrapper__item-link" aria-label="facebook"> 
                                <svg width="11" height="21" viewBox="0 0 9 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="socials-wrapper__item">
                            <a href="#" class="socials-wrapper__item-link">
                                <svg width="19" height="16" viewBox="0 0 15 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="socials-wrapper__item">
                            <a href="#" class="socials-wrapper__item-link">
                                <svg width="21" height="16" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
